...
const AppContent: React.FC = () => {
  ...
  // Show splash screen until audio is unlocked (only on main app, not story pages)
  if (!isAudioUnlocked && !isStoryPage) {
    return (
      <div className="relative w-full h-[100dvh] bg-black text-white font-sans overflow-hidden flex flex-col items-center justify-center">
        ...
        <div className="relative z-10 flex flex-col items-center gap-8 px-8 text-center">
          ...
          <p className="text-[10px] text-gray-500 mt-4">
            Powered by Grok TTS • {XAI_API_KEY ? '✓ Live Search' : 'Demo Mode'}
          </p>
        </div>
      </div>
    );
  ...
  return (
    <>
      <Routes>
        {/* Story page route - standalone page */}
